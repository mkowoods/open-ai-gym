...
"""
solution for frozen lake environment
environment choose action (0, up), (1, right), (2, down), (3, left)
prob_dist, env.P[state][action] => prob_dist of next_state
"""


env = gym.make('FrozenLake-v0')
#env.monitor.start("rec", force=True)
